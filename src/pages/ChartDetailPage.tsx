...
export default function ChartDetailPage() {
  ...
  if (isLoading) {
    return (
      <PageShell withFooter={false} maxWidth="7xl" contentClassName="flex items-center justify-center py-12">
  ...
  if (error || !data) {
    return (
      <PageShell withFooter={false} maxWidth="7xl" contentClassName="py-6">
  ...
  return (
    <PageShell maxWidth="7xl" contentClassName="py-3">
                      ...
                      <Link to={linkPath}>
                        ...
                        >
                          ...
                          <div className="absolute top-0 left-0 pointer-events-none" style={{ zIndex: 10 }}>
                            <div
                              className={`relative ${
                                entry.rank === 1 ? 'w-8 h-8 sm:w-10 h-10' : 'w-6 h-6 sm:w-8 h-8'
                              }`}
                            >
                              <img
                                src={
                                  entry.rank === 1
                                    ? '/laurel-wreath-top1.png'
                                    : entry.rank === 2
                                    ? '/laurel-wreath-top2.png'
                                    : entry.rank === 3
                                    ? '/laurel-wreath-top3.png'
                              ...
                              />
                              <div
                                className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white font-bold leading-none whitespace-nowrap ${
