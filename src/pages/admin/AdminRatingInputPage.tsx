      ...
      <div className="space-y-6">
        ...
        <section className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800/50 p-4">
          ...
          <div className="flex flex-wrap gap-2 max-h-48 overflow-y-auto">
            {selectedMedia && (
              <div
                className="flex items-center gap-2 px-3 py-2 rounded-lg bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-200"
              >
            ...
            {!selectedMedia &&
              filteredItems.map((item) => (
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-600 hover:border-blue-400 dark:hover:border-blue-600 text-left"
                >
                  {item.poster && (
