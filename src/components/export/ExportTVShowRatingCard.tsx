// ==========================================
// 剧集导出卡片组件 - 用于生成PNG图片的剧集评分卡片（支持分季）
// ==========================================
        ...
        <div className="flex-1 ml-20">
          <div className="mb-6">
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white">
              {tvShow.title} <span className="text-gray-500 dark:text-gray-300">({tvShow.year})</span>
              {selectedSeason && (
                <span className="text-gray-500 dark:text-gray-300"> - 第 {selectedSeason} 季</span>
              )}
            </h1>
          </div>
