...
import { MiniFavoriteButton } from './MiniFavoriteButton';
...
export function MediaCard({ item }: MediaCardProps) {
  ...
  return (
    <div className="group block">
      <div className="bg-white rounded-lg shadow-md overflow-hidden transition-all duration-200 hover:shadow-lg relative">
        <Link to={linkPath}>
          <div className="flex">
            {/* 海报 */}
